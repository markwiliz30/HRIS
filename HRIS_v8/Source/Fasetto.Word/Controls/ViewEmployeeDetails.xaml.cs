...
namespace Fasetto.Word
{
    ...
    public partial class ViewEmployeeDetails : UserControl
    {
        ...
        public ViewEmployeeDetails(EmployeeItem empItem)
        {
            ...
            List<string> a = new List<string> { "reg", "con", "pro" };
            //cbEmpStatus.ItemsSource = a;
        ...
        private void displayDetails(EmployeeItem item)
        {
            ...
            cbPosition.SelectedValue = item._POS_ID;
            cbEmpStatus.SelectedItem = SetEmpStatus(item._EMP_STATUS);
        ...
        private Enum SetEmpStatus(string item)
        {
            ...
            {
                case "Provisionary":
                    return EmployeeStatus.Provisionary;
                case "Regular":
                    return EmployeeStatus.Regular;
                case "Contractual":
                    return EmployeeStatus.Contractual;
                default:
                    return null;
            }
        }
